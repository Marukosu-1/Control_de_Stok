...
public class ControlDeStockFrame extends JFrame {
    ...
    private void modificar() {
        ...
        Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
                    ...
                    var filaModificadas = this.productoController.modificar(nombre, descripcion, cantidad, id);

                    
                    filaModificadas =this.productoController.modificar(nombre, descripcion,cantidad ,id );
                    JOptionPane.showMessageDialog(this, String.format("%d item modificado con éxito!", filaModificadas));
                }, () -> JOptionPane.showMessageDialog(this, "Por favor, elije un item"));
    }
    ...
    private void eliminar() {
        ...
        Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
                    Integer id = Integer.valueOf(modelo.getValueAt(tabla.getSelectedRow(), 0).toString());                                                 
                    var filaModificadas = this.productoController.eliminar(id);                    
